...
namespace Sujiya
{
    ...
    {
        public static ILog log = LogManager.GetLogger($"{nameof(Sujiya)}.{nameof(Mod)}").SetShowsErrorsInUI(false);
        ...
        public void OnLoad(UpdateSystem updateSystem)
        {
            ...
            AssetDatabase.global.LoadSettings(nameof(Sujiya), m_Setting, new Setting(this));
        }
